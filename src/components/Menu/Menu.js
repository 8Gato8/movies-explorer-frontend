	...
	return (
		<>
			...
			<ul className="nav__list nav__list_type_logged-in nav__list_type_hidden">
				...
				<li className="nav__item nav__item_type_movies"><Link className="nav__link nav__link_type_movies" to="пока неизвестный роут">Фильмы</Link></li>

				<li className="nav__item nav__item_type_saved-movies"><Link className="nav__link nav__link_type_saved-movies" to="movies">Сохранённые фильмы</Link></li>
